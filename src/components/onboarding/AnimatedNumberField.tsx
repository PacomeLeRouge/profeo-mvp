        ...
        <div className="mt-6 flex items-center justify-center gap-4 sm:gap-6">
          ...
          >
            <input
              ...
              className="w-full border-0 bg-transparent text-center text-4xl font-semibold tabular-nums tracking-tight text-foreground outline-none placeholder:text-muted-foreground/75 sm:text-5xl md:text-6xl"
            />
            {(unit || (value && suffix)) ? (
